...
<div class="well col-light-yellow">
		<form:form  method="POST" enctype="multipart/form-data" commandName="register" modelAttribute="personalDetails">
		 <fieldset>
			...
			<div class="span3">
                ...
                <label class="control-label">Photo</label>                	
                	...
                	<img id="pfPhoto" class="pull-left img-polaroid" alt="Polaroid Image"
                	 src='<c:url value="/assets/img/school_student.png"/>'/>
            ...
            <div class="span8">
                ...
                <label class="control-label">Email</label>                	
                	<div class="controls">
                    	<form:input path="email" cssErrorClass="error" placeholder="test@gmail.com"/>
                    </div>
                </div>
                <div class='control-group <c:if test="${not empty pwd_er}">error</c:if> span4'>
